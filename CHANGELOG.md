...
- Fix: include `dist/entry.js` in npm package to resolve global install failures. (#3914) Thanks @ANWGHO.
- Build: add prepack verification script to catch missing critical files before publishing.

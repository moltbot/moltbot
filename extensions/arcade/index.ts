 ...
 *
 * Provides integration with Arcade.dev for 500+ authorized tools (7500+ with useApiTools) including:
...
const arcadePlugin = {
  id: "arcade",
  name: "Arcade.dev",
  description: "Connect to Arcade.dev for 500+ authorized tools (Gmail, Slack, GitHub, etc.)",

---
summary: "Arcade.dev plugin: 500+ authorized tools (7500+ with API toolkits) with automatic OAuth"
read_when:
...
Connect OpenClaw to [Arcade.dev](https://arcade.dev) for **500+ authorized tools** (7500+ with `useApiTools: true`) across hundreds of services. Arcade handles OAuth automatically—no credential management required.
